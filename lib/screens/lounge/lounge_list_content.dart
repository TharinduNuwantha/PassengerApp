...
/// Content-only lounge list (no header, for embedding in tabs)
class LoungeListContent extends StatefulWidget {
  const LoungeListContent({super.key});

  @override
  State<LoungeListContent> createState() => _LoungeListContentState();
}

class _LoungeListContentState extends State<LoungeListContent> {
